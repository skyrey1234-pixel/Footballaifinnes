...
function analyzeModule(module: AdvancedAnalyticsModule, instructions: string, save: SaveFn, requiredExternalInputs: string[] = []) {
  return protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      const data = await runGuardedAnalytics({ module, report, instructions, requiredExternalInputs, verifiedContext: input.context });
      await save(input.sessionId, data);
