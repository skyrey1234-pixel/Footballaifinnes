...
import {
  ArrowLeft, Swords, Shield, Timer, AlertTriangle,
...
const TABS = [
  { id: 'report',    label: 'Scouting Report', icon: FileText },
      ...
      <div className="mb-6">
        ...
        {session.game_date && (
          <p className="text-sm text-slate-500 mt-1">
            {format(new Date(session.game_date), 'MMMM d, yyyy')}
          </p>
        )}
      </div>
            ...
            return (
              ...
              >
                ...
                {tab.id === 'film' && isActive && (
                  <span className="text-[10px] font-bold bg-[#0D1117]/20 px-1.5 py-0.5 rounded-full">NEW</span>
                )}
                {tab.id === 'film' && !isActive && (
            ...
            {analyzing && (
              <div className="bg-[#161B22] border border-white/5 rounded-xl p-10 text-center">
                ...
                <p className="text-sm text-slate-500 mt-1.5">
                  The AI is watching the footage and building your full scouting report. This can take a minute or two.
                </p>
              </div>
            )}
